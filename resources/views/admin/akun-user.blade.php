                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <form action="{{ route('akun.deleteUser', $d->id) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('akun.updateUser', $d->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="role" name="role" value="{{ $d->role }}" required>
                                                </div>
                                            </div>
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('akun.storeUser') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name">Nama</label>
